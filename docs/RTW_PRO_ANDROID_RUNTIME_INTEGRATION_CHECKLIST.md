...
- [ ] Google Sign-In Activity result에서 ID token 수신
- [ ] Firebase credential sign-in 성공/실패 분기 처리
- [ ] 토큰 만료/재로그인 경로 검증
...
## Push (FCM)
- [ ] 앱 시작 시 FCM token 동기화
- [ ] token refresh 콜백 시 재등록
- [ ] 정기 이벤트 topic subscribe/unsubscribe
