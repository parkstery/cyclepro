...
## 실행 체크리스트
- [x] R3-01 룸 상태머신(waiting->countdown->running->ended) 구현
- [x] R3-02 초기 동기화 정책(1~2Hz 업로드/1Hz 집계/stale 판정) 구현
- [x] R3-03 결과 산출 규칙(rank/gap/dnf) 도메인 계산기 구현
- [x] R3-04 재입장 스냅샷 복구/네트워크 단절 예측 이동 규칙 구현
